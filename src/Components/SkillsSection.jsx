...
export const PlaywrightIcon = ({ className }) => (
  <svg
    className={className}
    width="1em"
    height="1em"
  ...
  >
    <mask id="playwright-mask">
      ...
      />
      <path
        d="M141.946 245.451L131.072 248.537C133.641 263.019 138.169 276.917 145.276 289.195C146.513 288.922 147.74 288.687 149 288.342C152.302 287.451 155.364 286.348 158.312 285.145C150.371 273.361 145.118 259.789 141.946 245.451Z"
        fill="black"
      />
    </mask>

    <g mask="url(#playwright-mask)" fill="currentColor">
    ...
    <div className={styles.rootCont} id="skills">
      <Fade bottom>
        ...
        <div className={styles.skillsContFront}>
          ...
          <SkillCard
            skill="CSS3"
            icon={<FaCss3Alt className={styles.skillIcon} />}
          />
        </div>
        ...
        <div className={styles.toolsDiv}>
          ...
          <SkillCard
            skill="Playwright"
            icon={<PlaywrightIcon className={styles.skillIcon} />}
          />
          <SkillCard
            skill="Cypress"
